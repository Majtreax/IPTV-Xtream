...
class _AudioOverlayState extends State<AudioOverlay> {
  final _focusNode = FocusNode(debugLabel: 'AudioOverlay');
  ...
  void initState() {
    super.initState();
    _focusedIndex = widget.activeTrackIndex < 0 ? 0 : widget.activeTrackIndex;
        ...
        onKeyEvent: (node, event) {
          if (event is KeyDownEvent) {
            if (event.logicalKey == LogicalKeyboardKey.arrowUp) {
              ...
              widget.onTrackSelected(_focusedIndex);
              return KeyEventResult.handled;
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: List.generate(widget.tracks.length, (index) {
                      ...
                      final label = LanguageHelper.getLabel(track, index + 1);
                      final isActive = index == widget.activeTrackIndex;
                      final isItemFocused = index == _focusedIndex && isFocused;

                      return GestureDetector(
                        onTap: () {
                          _focusNode.requestFocus();
                          widget.onTrackSelected(index);
                        },
                        child: MouseRegion(
